...
class _MinecraftEnumModule:
    ActorDamageCause            = ActorDamageCause              # type: Type[ActorDamageCause]
    AniCheatBlockBreak          = AniCheatBlockBreak            # type: Type[AniCheatBlockBreak]
    AniCheatConsts              = AniCheatConsts                # type: Type[AniCheatConsts]
    AniCheatMove                = AniCheatMove                  # type: Type[AniCheatMove]
    AniCheatMoveRewind          = AniCheatMoveRewind            # type: Type[AniCheatMoveRewind]
    AnimationModeType           = AnimationModeType             # type: Type[AnimationModeType]
    ArmorSlotType               = ArmorSlotType                 # type: Type[ArmorSlotType]
    AttrType                    = AttrType                      # type: Type[AttrType]
    AttributeBuffType           = AttributeBuffType             # type: Type[AttributeBuffType]
    AttributeModifierOperation  = AttributeModifierOperation    # type: Type[AttributeModifierOperation]
    AttributeOperands           = AttributeOperands             # type: Type[AttributeOperands]
    BiomeType                   = BiomeType                     # type: Type[BiomeType]
    BlockBreathability          = BlockBreathability            # type: Type[BlockBreathability]
    BrewingStandSlotType        = BrewingStandSlotType          # type: Type[BrewingStandSlotType]
    ButtonEventType             = ButtonEventType               # type: Type[ButtonEventType]
    ButtonState                 = ButtonState                   # type: Type[ButtonState]
    CatVariantType              = CatVariantType                # type: Type[CatVariantType]
    Change                      = Change                        # type: Type[Change]
    ColorCode                   = ColorCode                     # type: Type[ColorCode]
    CommandBlockType            = CommandBlockType              # type: Type[CommandBlockType]
    ConditionType               = ConditionType                 # type: Type[ConditionType]
    ContainerType               = ContainerType                 # type: Type[ContainerType]
    EffectType                  = EffectType                    # type: Type[EffectType]
    EnchantSlotType             = EnchantSlotType               # type: Type[EnchantSlotType]
    EnchantType                 = EnchantType                   # type: Type[EnchantType]
    EntityColorType             = EntityColorType               # type: Type[EntityColorType]
    EntityComponentType         = EntityComponentType           # type: Type[EntityComponentType]
    EntityTeleportCause         = EntityTeleportCause           # type: Type[EntityTeleportCause]
    EntityType                  = EntityType                    # type: Type[EntityType]
    Facing                      = Facing                        # type: Type[Facing]
    FoxType                     = FoxType                       # type: Type[FoxType]
    GameDiffculty               = GameDiffculty                 # type: Type[GameDiffculty]
    GameType                    = GameType                      # type: Type[GameType]
    GamepadKeyType              = GamepadKeyType                # type: Type[GamepadKeyType]
    HorseSpotType               = HorseSpotType                 # type: Type[HorseSpotType]
    HorseType                   = HorseType                     # type: Type[HorseType]
    InputMode                   = InputMode                     # type: Type[InputMode]
    InventoryType               = InventoryType                 # type: Type[InventoryType]
    ItemAcquisitionMethod       = ItemAcquisitionMethod         # type: Type[ItemAcquisitionMethod]
    ItemCategory                = ItemCategory                  # type: Type[ItemCategory]
    ItemColor                   = ItemColor                     # type: Type[ItemColor]
    ItemPosType                 = ItemPosType                   # type: Type[ItemPosType]
    ItemType                    = ItemType                      # type: Type[ItemType]
    ItemUseMethodEnum           = ItemUseMethodEnum             # type: Type[ItemUseMethodEnum]
    KeyBoardType                = KeyBoardType                  # type: Type[KeyBoardType]
    MirrorModeType              = MirrorModeType                # type: Type[MirrorModeType]
    OpenContainerId             = OpenContainerId               # type: Type[OpenContainerId]
    OptionId                    = OptionId                      # type: Type[OptionId]
    OriginGUIName               = OriginGUIName                 # type: Type[OriginGUIName]
    PermissionChangeCause       = PermissionChangeCause         # type: Type[PermissionChangeCause]
    PistonFacing                = PistonFacing                  # type: Type[PistonFacing]
    PlayerActionType            = PlayerActionType              # type: Type[PlayerActionType]
    PlayerExhauseRatioType      = PlayerExhauseRatioType        # type: Type[PlayerExhauseRatioType]
    PlayerUISlot                = PlayerUISlot                  # type: Type[PlayerUISlot]
    PxActorFlag                 = PxActorFlag                   # type: Type[PxActorFlag]
    PxEventMask                 = PxEventMask                   # type: Type[PxEventMask]
    PxForceMode                 = PxForceMode                   # type: Type[PxForceMode]
    PxRigidBodyFlag             = PxRigidBodyFlag               # type: Type[PxRigidBodyFlag]
    PxRigidDynamicLockFlag      = PxRigidDynamicLockFlag        # type: Type[PxRigidDynamicLockFlag]
    RayFilterType               = RayFilterType                 # type: Type[RayFilterType]
    RedstoneModeType            = RedstoneModeType              # type: Type[RedstoneModeType]
    RenderControllerArrayType   = RenderControllerArrayType     # type: Type[RenderControllerArrayType]
    RenderLayer                 = RenderLayer                   # type: Type[RenderLayer]
    SetBlockType                = SetBlockType                  # type: Type[SetBlockType]
    ShapeType                   = ShapeType                     # type: Type[ShapeType]
    SliderOptionId              = SliderOptionId                # type: Type[SliderOptionId]
    StructureFeatureType        = StructureFeatureType          # type: Type[StructureFeatureType]
    TimeEaseType                = TimeEaseType                  # type: Type[TimeEaseType]
    TouchEvent                  = TouchEvent                    # type: Type[TouchEvent]
    TradeLevelType              = TradeLevelType                # type: Type[TradeLevelType]
    TransferServerFailReason    = TransferServerFailReason      # type: Type[TransferServerFailReason]
    UICategory                  = UICategory                    # type: Type[UICategory]
    UiBaseLayer                 = UiBaseLayer                   # type: Type[UiBaseLayer]
    UseAnimation                = UseAnimation                  # type: Type[UseAnimation]
    VillagerClothingType        = VillagerClothingType          # type: Type[VillagerClothingType]
    VirtualWorldObjectType      = VirtualWorldObjectType        # type: Type[VirtualWorldObjectType]
    WalkState                   = WalkState                     # type: Type[WalkState]
