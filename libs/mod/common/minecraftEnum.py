...
class _MinecraftEnumModule:
    ActorDamageCause            = ActorDamageCause              # type: ActorDamageCause
    AniCheatBlockBreak          = AniCheatBlockBreak            # type: AniCheatBlockBreak
    AniCheatConsts              = AniCheatConsts                # type: AniCheatConsts
    AniCheatMove                = AniCheatMove                  # type: AniCheatMove
    AniCheatMoveRewind          = AniCheatMoveRewind            # type: AniCheatMoveRewind
    AnimationModeType           = AnimationModeType             # type: AnimationModeType
    ArmorSlotType               = ArmorSlotType                 # type: ArmorSlotType
    AttrType                    = AttrType                      # type: AttrType
    AttributeBuffType           = AttributeBuffType             # type: AttributeBuffType
    AttributeModifierOperation  = AttributeModifierOperation    # type: AttributeModifierOperation
    AttributeOperands           = AttributeOperands             # type: AttributeOperands
    BiomeType                   = BiomeType                     # type: BiomeType
    BlockBreathability          = BlockBreathability            # type: BlockBreathability
    BrewingStandSlotType        = BrewingStandSlotType          # type: BrewingStandSlotType
    ButtonEventType             = ButtonEventType               # type: ButtonEventType
    ButtonState                 = ButtonState                   # type: ButtonState
    CatVariantType              = CatVariantType                # type: CatVariantType
    Change                      = Change                        # type: Change
    ColorCode                   = ColorCode                     # type: ColorCode
    CommandBlockType            = CommandBlockType              # type: CommandBlockType
    ConditionType               = ConditionType                 # type: ConditionType
    ContainerType               = ContainerType                 # type: ContainerType
    EffectType                  = EffectType                    # type: EffectType
    EnchantSlotType             = EnchantSlotType               # type: EnchantSlotType
    EnchantType                 = EnchantType                   # type: EnchantType
    EntityColorType             = EntityColorType               # type: EntityColorType
    EntityComponentType         = EntityComponentType           # type: EntityComponentType
    EntityTeleportCause         = EntityTeleportCause           # type: EntityTeleportCause
    EntityType                  = EntityType                    # type: EntityType
    Facing                      = Facing                        # type: Facing
    FoxType                     = FoxType                       # type: FoxType
    GameDiffculty               = GameDiffculty                 # type: GameDiffculty
    GameType                    = GameType                      # type: GameType
    GamepadKeyType              = GamepadKeyType                # type: GamepadKeyType
    HorseSpotType               = HorseSpotType                 # type: HorseSpotType
    HorseType                   = HorseType                     # type: HorseType
    InputMode                   = InputMode                     # type: InputMode
    InventoryType               = InventoryType                 # type: InventoryType
    ItemAcquisitionMethod       = ItemAcquisitionMethod         # type: ItemAcquisitionMethod
    ItemCategory                = ItemCategory                  # type: ItemCategory
    ItemColor                   = ItemColor                     # type: ItemColor
    ItemPosType                 = ItemPosType                   # type: ItemPosType
    ItemType                    = ItemType                      # type: ItemType
    ItemUseMethodEnum           = ItemUseMethodEnum             # type: ItemUseMethodEnum
    KeyBoardType                = KeyBoardType                  # type: KeyBoardType
    MirrorModeType              = MirrorModeType                # type: MirrorModeType
    OpenContainerId             = OpenContainerId               # type: OpenContainerId
    OptionId                    = OptionId                      # type: OptionId
    OriginGUIName               = OriginGUIName                 # type: OriginGUIName
    PermissionChangeCause       = PermissionChangeCause         # type: PermissionChangeCause
    PistonFacing                = PistonFacing                  # type: PistonFacing
    PlayerActionType            = PlayerActionType              # type: PlayerActionType
    PlayerExhauseRatioType      = PlayerExhauseRatioType        # type: PlayerExhauseRatioType
    PlayerUISlot                = PlayerUISlot                  # type: PlayerUISlot
    PxActorFlag                 = PxActorFlag                   # type: PxActorFlag
    PxEventMask                 = PxEventMask                   # type: PxEventMask
    PxForceMode                 = PxForceMode                   # type: PxForceMode
    PxRigidBodyFlag             = PxRigidBodyFlag               # type: PxRigidBodyFlag
    PxRigidDynamicLockFlag      = PxRigidDynamicLockFlag        # type: PxRigidDynamicLockFlag
    RayFilterType               = RayFilterType                 # type: RayFilterType
    RedstoneModeType            = RedstoneModeType              # type: RedstoneModeType
    RenderControllerArrayType   = RenderControllerArrayType     # type: RenderControllerArrayType
    RenderLayer                 = RenderLayer                   # type: RenderLayer
    SetBlockType                = SetBlockType                  # type: SetBlockType
    ShapeType                   = ShapeType                     # type: ShapeType
    SliderOptionId              = SliderOptionId                # type: SliderOptionId
    StructureFeatureType        = StructureFeatureType          # type: StructureFeatureType
    TimeEaseType                = TimeEaseType                  # type: TimeEaseType
    TouchEvent                  = TouchEvent                    # type: TouchEvent
    TradeLevelType              = TradeLevelType                # type: TradeLevelType
    TransferServerFailReason    = TransferServerFailReason      # type: TransferServerFailReason
    UICategory                  = UICategory                    # type: UICategory
    UiBaseLayer                 = UiBaseLayer                   # type: UiBaseLayer
    UseAnimation                = UseAnimation                  # type: UseAnimation
    VillagerClothingType        = VillagerClothingType          # type: VillagerClothingType
    VirtualWorldObjectType      = VirtualWorldObjectType        # type: VirtualWorldObjectType
    WalkState                   = WalkState                     # type: WalkState
